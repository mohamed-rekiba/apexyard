...
- `.claude/` — framework hooks, agents, rules, skills, settings.json
  - `.claude/hooks/` — 49 shell scripts (PreToolUse / PostToolUse / SessionStart)
  ...
  - `.claude/rules/` — 22 modular rule files, loaded automatically; `CLAUDE.md` carries the trigger for each, not an import (AgDR-0115)
  - `.claude/settings.json` — hook wiring
- `roles/` — 20 role definitions across Engineering, Product, Design, Security, Data
